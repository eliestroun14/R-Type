...
namespace gameEngine {
    ...
    void GameEngine::createPlayer()
    {
        ...
        _coordinator->addComponent<Sprite>(player, Sprite(PLAYER_1, ZIndex::IS_GAME, sf::IntRect(0, 0, 33, 15)));
    ...
    void GameEngine::createEnemies()
    {
        ...
        _coordinator->addComponent<Sprite>(staticEnemy, Sprite(BASE_ENEMY, ZIndex::IS_GAME, sf::IntRect(0, 0, 33, 36)));
        ...
        _coordinator->addComponent<AI>(staticEnemy, AI(AiBehaviour::KAMIKAZE, 200.f, 200.f));  // 300ms fire rate, 8 damage
    }
